...
nat_map_download <- function(year, ...){
  ...
  url_git = paste0("https://github.com/emitanaka/eechidna/raw/master/extra-data/nat_map", suffix, ".rda")
...
nat_data_download <- function(year, ...){
  ...
  year = as.numeric(year)
  suffix = substr(year, 3, 4)
  url_git = paste0("https://github.com/emitanaka/eechidna/raw/master/extra-data/nat_data", suffix, ".rda")
...
sF_download <- function(year, ...){
  ...
  year = as.numeric(year)
  suffix = substr(year, 3, 4)
  url_git = paste0("https://github.com/emitanaka/eechidna/raw/master/extra-data/sF_", suffix, ".rda")
...
firstpref_pollingbooth_download <- function(...){
  fp_pp <- 1
  tmp <- tempfile()
  utils::download.file("https://github.com/emitanaka/eechidna/raw/master/extra-data/fp_pp.rda", tmp)
  load(tmp)
  fp_pp 
}
...
twoparty_pollingbooth_download <- function(...){
  tpp_pp <- 1
  tmp <- tempfile()
  utils::download.file("https://github.com/emitanaka/eechidna/raw/master/extra-data/tpp_pp.rda", tmp)
  load(tmp)
  tpp_pp 
}
...
twocand_pollingbooth_download <- function(...){
  tcp_pp <- 1
  tmp <- tempfile()
  utils::download.file("https://github.com/emitanaka/eechidna/raw/master/extra-data/tcp_pp.rda", tmp)
  load(tmp)
  tcp_pp 
}
