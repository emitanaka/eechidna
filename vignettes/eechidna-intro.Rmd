...
# Bind and plot 
# some how needs it to be a data frame. Gets the following message:
#Can't combine <spec_tbl_df> and <tbl_df>.
#ℹ Convert all inputs to the same class to avoid this warning.
#ℹ Falling back to <data.frame>. 
bind_rows(as.data.frame(mutate(abs2016, year = "2016")), 
          as.data.frame(mutate(abs2011, year = "2011")),
          as.data.frame(mutate(abs2011, year = "2006")),
          as.data.frame(mutate(abs2011, year = "2001"))
          ) %>% 
